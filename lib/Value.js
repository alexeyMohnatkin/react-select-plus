...
var Value = (_dec = (0, _reactCssThemr.themr)('React-Select-Plus'), _dec(_class = function (_Component) {
	...
	function Value(props) {
		...
		_this.renderRemoveIcon = _this.renderRemoveIcon.bind(_this);
	...
	_createClass(Value, [{
		...
		value: function renderLabel() {
			...
			var className = theme.valueLabel;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: (0, _classnames2.default)(theme.value, this.props.value.className),
